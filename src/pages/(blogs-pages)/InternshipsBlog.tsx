...
import Img21 from "../../assets/images/placementSuccess11.jpeg";
import Img22 from "../../assets/images/placementSuccess12.jpeg";
import Img23 from "../../assets/images/placementSuccess13.jpeg";
import Img24 from "../../assets/images/placementSuccess14.jpeg";
import Img25 from "../../assets/images/placementSuccess15.jpeg";
          ...
          <section className="w-full h-full relative lg:w-[100%] lg:mx-auto grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-5">
            <div className="group w-full h-full lg:col-span-3 flex flex-col gap-y-3 md:gap-y-6 border-b mb-9 border-lightgray lg:border-none lg:mb-0">
              ...
              <div className="w-full h-auto flex flex-col gap-y-4 md:gap-y-6">
                ...
                <div className="w-full h-auto p-3 md:p-4">
                ...
                <div className="w-full h-auto p-3 md:p-4">
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold font-lora my-5">
                    YugAmjTeam on Campus: Mentoring the Next Generation of IT
