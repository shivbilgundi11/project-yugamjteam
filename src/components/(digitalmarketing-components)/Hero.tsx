...
const Hero: React.FC = () => {
  useEffect(() => {
    ...
    const others =
      document.querySelectorAll<HTMLParagraphElement>(".opacityDelay");
  ...
  return (
    <section className="relative w-full h-screen lg:h-[85vh] mark-bg">
      ...
      <div className="container relative mx-auto flex h-full w-full flex-col items-center justify-center gap-y-3 p-4 text-center md:items-start md:text-left md:gap-y-5">
        ...
        <p className="opacityDelay bg-slate-300 flex items-center justify-center rounded-full bg-gray-200 py-1 px-3 font-lora text-lg font-medium text-black opacity-0">
        ...
        <div className="opacityDelay opacity-0">
          <p className="mt-4 text-lg sm:text-xl md:text-2xl lg:text-2xl font-lora">
            At YugAmjTeam, we offer comprehensive digital marketing services to
            help businesses thrive online. From SEO to social media and beyond,
            we leverage the latest tools and strategies to drive measurable
            results and achieve your marketing objectives.
          </p>
        </div>
      </div>
    </section>
