...
const BenefitsCards: React.FC = () => {
  const cards: CardProps[] = [
    {
      icon: "/src/assets/images/InternshipImages/WhyUs-BenifitCards/handsonExp.gif",
    ...
    {
      icon: "/src/assets/images/InternshipImages/WhyUs-BenifitCards/certificate.gif",
      title: "Certification",
      description:
    ...
    {
      icon: "/src/assets/images/InternshipImages/WhyUs-BenifitCards/time.gif",
    ...
    {
      icon: "/src/assets/images/InternshipImages/WhyUs-BenifitCards/requ.gif",
      title: "Requirements",
      description:
