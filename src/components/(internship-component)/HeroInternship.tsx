...
export default function Hero() {
  ...
  return (
    <>
      <section className="w-full">
        <div className="container mx-auto p-4 flex flex-col md:flex-row items-center justify-between gap-x-3 md:gap-x-8">
          {/* Content Section */}
          <div className="flex flex-col items-start justify-center gap-y-3 md:gap-y-5 w-full md:w-1/2 order-first md:order-none">
            <div className="text-lg sm:text-xl md:text-2xl bg-off-white px-4 py-4 mt-7 rounded-full flex items-center justify-center gap-x-4 opacityDelay opacity-0">
              Welcome to YugAmjTeam
            </div>
            <div>
          ...
          <div className="image object-center text-center mt-5 order-last md:order-none">
            <img
              src="https://i.imgur.com/WbQnbas.png"
              alt="Company Image"
              className="w-full md:w-[550px] pt-6 h-auto"
            />
          </div>
        </div>
      </section>
